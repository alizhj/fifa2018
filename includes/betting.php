...
<div class="container-fluid">
	<div class="row">
		...
		while($row = mysqli_fetch_assoc($result)) {
			...
			if($betOpen){ 
				...
				<tr id="betGames" class="betGames">
					...
					<td style="text-align:center;"><img class="flag" src="img/flags/<?php echo $home_flag; ?>" /></td>
					<td style="text-align:center;"> VS </td>
					<td style="text-align:center;" ><img class="flag" src="img/flags/<?php echo $away_flag; ?>" />
					...
					<td>
						<div class="error">
							You have to fill in both scores
						</div>
				...
				<?php 
					...
					<tr class="toggleTr" rel="<?php echo $game_id; ?>">
						...
						<td style="text-align:center;" class="locked"><img class="flag" src="img/flags/<?php echo $home_flag; ?>" /></td>
						...
						<td style="text-align:center;" class="locked" colspan="2"><?php echo $goal_home; ?> - <?php echo $goal_away; ?></td>
						<td style="text-align:center;" class="locked" colspan="2">Result </br>(<?php echo $result_goal_home; ?> - <?php echo $result_goal_away; ?>)</td>
					</tr>
		...
		<h1 style="padding-top: 20px;">Knockout Phase</h1>
			<?php 
...
>>>>>>> 7b94ce2daf7d5a3c0d23817ce6f3b7eae40dfdfc
					</tr>
		...
		<button id="check" class="col-sm-12 btn btn-default" name="save_bets" data-toggle="modal" data-target="#myModal" value="Spara Bets">Save bets</button>
		</div><!-- team_bet -->
	</div>
</div>
