...
<?php 
	...
	if(isset($_GET['tour_id']) && isset($_SESSION['user_id'])){
		...
		if (is_null($row)) {
			...
			echo 'The group you were seraching for does not exist or you dont have permissions to join. ^$_GET Check^';
			...
			if(is_null($row)){
				...
				echo 'The group you were seraching for does not exist or you dont have permissions to join. ^User_tournaments check^';
				...
				<div class="group_scoreboard">
					...
					<table class="table_scoreboard">
						...
						<tr>
							...
							<td><?php echo $row['user_points']; ?> points</td>
						</tr>
