			...
			<table>
				<tbody>
					<tr>
						...
						<td style="width:30px; text-align:right;"><img class="flag" src="img/flags/<?php echo $home_flag; ?>" /></td>
						<td style="width:40px; text-align:center;"> VS </td>
						<td style="width:30px"><img class="flag" src="img/flags/<?php echo $away_flag; ?>" /></td>
		...
		<tbody>
			...
			while($row = $result->fetch_assoc()) {
				...
				if ( "{$row['group_nr']}"  == $teamGroup){
					?>
					<tr>
						<td><img class="flag" src="img/flags/<?php echo "{$row['team_flag']}"; ?>" /></td>
