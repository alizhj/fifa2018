...
<!-- 		<div id='game_reg'>
		...
		<div class="result_winner col-sm-12">
			...
			<form action="includes/save_result.php" method="post">
				<label for="player">Best scorer:</label></br>
				<input type="text" name="player" /></br>

				<label for="winning_team">World Cup Winner:</label></br>
					...
					<table class="table1 col-sm-12">
						<tbody>
							<tr>
								...
								<td style="width:10%; text-align:center;"><img class="flag" src="img/flags/<?php echo $home_flag; ?>" /></td>
								<td style="width:10%; text-align:center;"> VS 
									<input type="hidden" name="game_id" value="<?php echo $game_id; ?>"></td>
								<td style="width:10%; text-align:center;"><img class="flag" src="img/flags/<?php echo $away_flag; ?>" />
